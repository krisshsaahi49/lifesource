                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                {/* <li className="dropdown submenu nav-item">
                                    <Link  exact title="Service" className="nav-link" to='/About'>About</Link> */}
                                    <li className="nav-item"><NavLink title="About" className="nav-link" to="/About">About</NavLink></li>
                                    
                                    {/* <ul role="menu" className=" dropdown-menu">
                                        <li className="nav-item"><NavLink exact title="Service" className="nav-link" to='/About'>About</NavLink></li>
                                    </ul> */}
                                {/* </li> */}
                                {/* <li className="dropdown submenu nav-item">
                                    <Link exact title="Faq" className="nav-link" to='/Mission'>Mission</Link> */}
                                    <li className="nav-item"><NavLink title="Mission" className="nav-link" to="/Mission">Mission</NavLink></li>
                                    {/* <ul role="menu" className=" dropdown-menu">
                                ...
                                {/* </li> */}
                                <li className="dropdown submenu nav-item"><Link title="Pages" className="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" to="#">Donor</Link>
                                    <ul role="menu" className=" dropdown-menu">
